  ...
  return (
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="conatainer mx-auto px-4 md:px-8 lg:px-16 space-y-8">
                ...
                <Card key={index} className="bg-background">
                  <CardContent className="pt-6">
                    <div>
                      ...
                      <blockquote>
                        <p className="text-muted-foreground mt-4 italic relative">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="conatainer mx-auto px-4 md:px-8 lg:px-16 space-y-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Find answers to common questions about our AI career coaching platform
            </p>
          </div>
      ...
      <section className="w-full">
        <div className="mx-auto px-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center  max-w-3xl mx-auto py-10">
